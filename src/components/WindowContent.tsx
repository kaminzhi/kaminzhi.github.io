...
const WindowContent: React.FC<WindowContentProps> = ({ type, onClose }) => {
  ...
  const [isVpnConnected, setIsVpnConnected] = useState<boolean | undefined>(
    undefined,
  );
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "vpn-status-change" as any,
      handleVpnStatusChange as any,
    );
      ...
      return (
        <div className="p-4 md:p-6 animate-fadeIn">
          <div className="flex flex-col md:flex-row items-center justify-center md:space-x-6 mb-6">
            <div className="flex items-center relative mb-6 md:mb-0">
              ...
              <div className="absolute top-2 right-3 md:top-8 md:right-10">
                <div
                  className={`relative transition-opacity duration-500 ${isPlaying ? "opacity-100" : "opacity-0"}`}
                >
              ...
              <div
                className={`absolute bottom-0 right-0 md:bottom-4 md:right-4 origin-bottom-right transform 
          ...
          <div className="space-y-6">
            <div
              className="bg-gray-50 bg-opacity-50 backdrop-blur-sm p-6 rounded-lg 
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-blue-200 text-gray-700 rounded-full text-sm
      ...
      return (
        <div className="p-6 animate-fadeIn">
          ...
          <div className="max-w-md mx-auto space-y-4">
            <a
              href="mailto:issac20050710@gmail.com"
            ...
            >
              ...
              <span className="text-black">issac20050710@gmail.com</span>
            </a>
            <a
              href="mailto:kamin@kaminzhi.com"
              className="flex items-center p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm rounded-lg
                hover:bg-gray-100 hover:bg-opacity-60 
                transition-all duration-200
                hover:scale-[1.02] hover:shadow-lg
            ...
            <a
              href="https://github.com/kaminzhi"
              className="flex items-center p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm rounded-lg
              hover:bg-gray-100 hover:bg-opacity-60 
              transition-all duration-200
              hover:scale-[1.02] hover:shadow-lg
            ...
            <a
              href="https://www.instagram.com/kamin_zhi/"
              className="flex items-center p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm rounded-lg
                hover:bg-gray-100 hover:bg-opacity-60 
                transition-all duration-200
                hover:scale-[1.02] hover:shadow-lg
            ...
            <a
              href="https://twitter.com/kamin_zhi"
              className="flex items-center p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm rounded-lg
                hover:bg-gray-100 hover:bg-opacity-60 
                transition-all duration-200
                hover:scale-[1.02] hover:shadow-lg
            ...
            <a
              href="https://discordapp.com/users/kamin_zhi"
              className="flex items-center p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm rounded-lg
                hover:bg-gray-100 hover:bg-opacity-60 
                transition-all duration-200
                hover:scale-[1.02] hover:shadow-lg
    ...
    case "terminal":
      return (
        <div className="h-full">
          <Terminal isActive={true} onClose={onClose} />
        </div>
      );
    default:
      return null;
